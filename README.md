...
A fast, zero-config file lister that groups files by kind instead of making you remember extensions. Find all images, documents, videos, audio, code, or archives in a directory with a single command. Supports magic-byte detection for more accurate classification, multiple output formats, and configurable sorting.
